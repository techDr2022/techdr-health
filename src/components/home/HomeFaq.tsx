...
export function HomeFaq() {
  const leftFaq = HOME_FAQ.slice(0, 6);
  const rightFaq = HOME_FAQ.slice(6, 12);
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mx-auto mt-3 max-w-2xl text-center text-muted-foreground">
        Straight answers about worldwide teleconsultation patients ask before
        their first video doctor visit.
      </p>
